...
**GCP A100 Instance Profile (Aaryaman's Run):**
* **Machine Type:** Google Colab Pro+ (A100 runtime)
* **GPU:** 1x NVIDIA A100-SXM4-80GB
* **GPU VRAM:** 80 GB *(Sufficient to run both baseline and EAGLE-3 servers simultaneously)*
* **CUDA Version:** 13.0 | **Driver:** 580.82.07
* **Architecture:** x86_64
* **Hourly Cost:** ~$3.67 / hr (GCP a2-highgpu-1g equivalent)
