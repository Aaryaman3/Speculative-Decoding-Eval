...
| ------------- | -------- | ---- | ---- | ---- | ---- | ---- | ---- | ----- |
| Chat          | Baseline | ~92  | ~90  | ~88  | ~80  | ~73  | ~55  | ~62   |
| Chat          | EAGLE-3  | ~137 | ~148 | ~171 | ~155 | ~96  | ~73  | ~82   |
| Code          | Baseline | ~108 | ~106 | ~102 | ~95  | ~85  | ~65  | ~72   |
| Code          | EAGLE-3  | ~309 | ~295 | ~242 | ~196 | ~134 | ~103 | ~114  |
| Summarization | Baseline | ~95  | ~93  | ~91  | ~84  | ~76  | ~58  | ~64   |
| Summarization | EAGLE-3  | ~223 | ~211 | ~164 | ~130 | ~90  | ~109 | ~75   |

**NVIDIA L4 (24GB)**

| Task          | System   | c=1 | c=4 | c=8 | c=16 | c=32 | c=64 | c=128 |
| ------------- | -------- | --- | --- | --- | ---- | ---- | ---- | ----- |
| Chat          | Baseline | ~20 | ~19 | ~16 | ~15  | ~14  | ~12  | ~10   |
| Chat          | EAGLE-3  | ~30 | ~32 | ~35 | ~32  | ~21  | ~15  | ~13   |
| Code          | Baseline | ~23 | ~22 | ~20 | ~19  | ~17  | ~14  | ~12   |
| Code          | EAGLE-3  | ~66 | ~61 | ~55 | ~44  | ~28  | ~23  | ~17   |
| Summarization | Baseline | ~21 | ~20 | ~18 | ~17  | ~15  | ~13  | ~11   |
| Summarization | EAGLE-3  | ~50 | ~47 | ~39 | ~32  | ~19  | ~14  | ~11   |
...
| ------------- | ----------- | ----------- | ----------- | ------------ | ------------ | ------------ | ------------- | --------- |
| Code          | **2.86×**   | **2.79×**   | **2.37×**   | **2.06×**    | **1.58×**    | **1.58×**    | **1.58×**     | >128      |
| Chat          | **1.49×**   | **1.64×**   | **1.94×**   | **1.94×**    | **1.32×**    | **1.33×**    | **1.32×**     | >128      |
| Summarization | **2.35×**   | **2.27×**   | **1.80×**   | **1.55×**    | **1.18×**    | **1.88×**    | **1.17×**     | >128      |

**NVIDIA L4 (24GB)**

| Task          | c=1 speedup | c=4 speedup | c=8 speedup | c=16 speedup | c=32 speedup | c=64 speedup | c=128 speedup | Crossover |
| ------------- | ----------- | ----------- | ----------- | ------------ | ------------ | ------------ | ------------- | --------- |
| Code          | **2.87×**   | **2.77×**   | **2.75×**   | **2.32×**    | **1.65×**    | **1.64×**    | **1.42×**     | >128      |
| Chat          | **1.50×**   | **1.68×**   | **2.19×**   | **2.13×**    | **1.50×**    | **1.25×**    | **1.30×**     | >128      |
| Summarization | **2.38×**   | **2.35×**   | **2.17×**   | **1.88×**    | **1.27×**    | **1.08×**    | **1.00×**     | ~128      |
